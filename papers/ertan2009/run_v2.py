"""
Ertan 2009 v2 — exact parameter replication.

Runs N=50 default + N=50 random personalities on ertan2009_v2 (group=4,
endowment=10, punishment ratio 1:4) using step-3.5-flash in chat mode.
"""
...
RESULTS_DIR = os.path.join(PROJECT_ROOT, "papers", "ertan2009", "results_v2")
